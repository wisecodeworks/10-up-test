...
wp_enqueue_style( 'wpb-google-fonts', 'https://fonts.google.com/specimen/Raleway', false );
}
add_action( 'wp_enqueue_scripts', 'wpb_add_google_fonts' );


	/*This theme's customizations (uncomment next line) */
	wp_enqueue_style( 'project-style', get_template_directory_uri() . '/library/css/10-up.min.css' );
